...
-- ------------------------------------------------------------------
-- 1. Defensive dedup against the new (date-less) uniqueness keys.
...
-- ------------------------------------------------------------------
-- 2. Drop work_date-scoped constraints / indexes
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- 3. Recreate uniqueness without work_date
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- 4. Normalize daily-status PKs to be employee-scoped instead of
...
-- ------------------------------------------------------------------
-- 5. Auto-populate work_date so the column can stay during the code
